...
<jsp:include page="part/header.jsp" />
	...
	<div id="main">
		...
		<% 
			...
			int startIndex = (pageIndex-1)*300;
			int endIndex = pageIndex*300;
			
			String realpath = request.getSession().getServletContext().getRealPath("/");
			List<String> list = new KeywordService().getKeywordListFromCache(realpath);
			...
			int i = 0;
 			for(String keyword : list){
 				...
 				if(i>startIndex && i< endIndex){
 					out.print("<a href='"+keyword+".htm'>"+keyword+"</a>");	
 				}
 			}
	...
	<div id="pages">
		<% 
			for(int p=1;p<=10;p++){
				out.print("<a href='map-"+ p +".htm'> "+p+"  </a>");	
			}
		%>
	</div>
